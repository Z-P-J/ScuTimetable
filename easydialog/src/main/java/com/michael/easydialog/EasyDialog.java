...
public class EasyDialog
{
    ...
    public static EasyDialog with(Context context) {
    ...
    public interface ViewCreateCallback {
        void onViewCreate(EasyDialog dialog, View view);
    }

    public EasyDialog setOnViewCreate(ViewCreateCallback callback) {
        if (contentView != null) {
            callback.onViewCreate(this, contentView);
            return this;
        } else {
            throw new RuntimeException("you must inti contentView");
        }
    }
    ...
    public void show(View attachedView)
    {
