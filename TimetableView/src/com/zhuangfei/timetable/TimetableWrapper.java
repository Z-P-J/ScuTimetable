...
public class TimetableWrapper {
     ...
     * @return
     */
    public TimetableWrapper isShowWeekends(boolean isShowWeekends) {
    ...
    public AbsOperater2 operater() {
        if (operater == null) {
            operater = new SimpleOperater2();
        }
        return operater;
    }

    public TimetableWrapper operater(AbsOperater2 operater) {
     ...
     * @return
     */
    public TimetableWrapper monthWidthDp(int monthWidthDp) {
     ...
     * @return
     */
    public TimetableWrapper monthWidthPx(int monthWidthPx) {
     ...
     * @return
     */
    public TimetableWrapper itemTextColor(int color, boolean isThisWeek) {
        if (isThisWeek) {
     ...
     * @return
     */
    public TimetableWrapper alpha(float dateAlpha, float slideAlpha, float itemAlpha) {
     ...
     * @return
     */
    public TimetableWrapper alpha(float allAlpha) {
     ...
     * @return
     */
    public TimetableWrapper flagBgcolor(int color) {
     ...
     * @return
     */
    public TimetableWrapper isShowFlaglayout(boolean isShowFlaglayout) {
     ...
     * @return
     */
    public TimetableWrapper curWeek(int curWeek) {
        if (curWeek < 1) {
            this.curWeek = 1;
        } else if (curWeek > 25) {
            this.curWeek = 25;
     ...
     * @return
     */
    public TimetableWrapper curWeek(String startTime) {
     ...
     * @return
     */
    public TimetableWrapper curTerm(String curTerm) {
     ...
     * @return
     */
    public TimetableWrapper data(List<Schedule> dataSource) {
     ...
     * @return
     */
    public TimetableWrapper source(List<? extends ScheduleEnable> dataSource) {
     ...
     * @return
     */
    public TimetableWrapper maxSlideItem(int maxSlideItem) {
     ...
     * @return
     */
    public TimetableWrapper thisWeekCorner(int thisWeekCorner) {
     ...
     * @return
     */
    public TimetableWrapper cornerAll(int cornerValue) {
     ...
     * @return
     */
    public TimetableWrapper corner(int corner, boolean isThisWeek) {
        if (isThisWeek) {
     ...
     * @return
     */
    public TimetableWrapper isShowNotCurWeek(boolean showNotCurWeek) {
     ...
     * @return
     */
    public TimetableWrapper marTop(int marTopPx) {
     ...
     * @return
     */
    public TimetableWrapper marLeft(int marLeftPx) {
     ...
     * @return
     */
    public TimetableWrapper itemHeight(int itemHeightPx) {
     ...
     * @param context
     */
    public TimetableWrapper(Context context, LinearLayout view) {
        this.containerView = view;
        this.context = context;
        operater().init(context, this);
    }

//    public static TimetableWrapper with(Context context, LinearLayout linearLayout) {
//        return new TimetableWrapper(context, null, linearLayout);
//    }
    ...
    public TimetableWrapper configName(String configName) {
