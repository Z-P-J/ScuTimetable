...
//    private AlarmReceiver alarmReceiver;
    ...
    private static final int ALARM_TYPR_BEFORE_CLASS_TEN_MIN = 1;
    private static final int ALARM_TYPE_CLASS_BEGAIN = 2;
    private static final int ALARM_TYPE_CLASS_END = 3;
    private static final int ALARM_TYPE_ON_CLASS_AFTER_CLASS = 3;
...
//            unregisterReceiver(alarmReceiver);
    ...
    private void initAlarmQueue() {
        ...
        int offsetMin = 0;
        for (int i = nextSubject.getStart() + 1; i < nextSubject.getEnd(); i++) {
...
//                textToSpeech.speak(nextSubject.getCourseName() + "课程将于" + deltaHour + "小时" + deltaMin + "分钟后开始", TextToSpeech.QUEUE_FLUSH, null);
//            }
        }
    }
