...
// * @date 2019
// */
//public final class LoginActivity_bak extends SupportActivity
...
////                        login();
//                    LoginUtil.with()
//                            .setLoginCallback(LoginActivity_bak.this)
//                            .login(
...
//                Intent intent = new Intent(LoginActivity_bak.this, MainActivity.class);
...
//        try {
//            TimetableHelper.writeToJson(LoginActivity_bak.this, jsonObject);
//        } catch (Exception e) {
//            e.printStackTrace();
//            onError();
//        }
...
//        try {
//            TimetableHelper.writeSemesterFile(LoginActivity_bak.this, json);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
...
//                    .setNegativeButton(R.string.text_decline, dialog -> ActivityCompat.finishAfterTransition(LoginActivity_bak.this))
//                    .show(this);
//        }
//    }
//
...
//                        if (TimetableHelper.isLogined(LoginActivity_bak.this)) {
//                            postDelayed(() -> {
//                                updateWidget(true);
