...
public abstract class BaseWeatherPanelView extends CardView
        implements ISlidingUpPanel<BaseWeatherPanelView> {
    ...
    protected SemesterInfo mSemesterInfo;
    ...
    public abstract void setSemesterInfo(SemesterInfo semesterInfo);
