...
// * @author Z-P-J
// */
//public final class MainActivity_bak extends SupportActivity implements View.OnClickListener, UpdateUtil.UpdateCallback {
//
...
//                        testY = location[1] + height / 2 - StatusBarUtil.getStatusBarHeight(MainActivity_bak.this);
...
//                .setBackgroundAlpha(MainActivity_bak.this, 0.9f, 500)
...
//                            OptionMenuView tools = new OptionMenuView(MainActivity_bak.this);
//                            tools.setOrientation(LinearLayout.VERTICAL);
//                            tools.inflate(R.menu.menu_tools, new MenuBuilder(MainActivity_bak.this));
...
//        CustomPopupMenuView.with(MainActivity_bak.this, R.layout.layout_subject_detail)
//                .setOrientation(LinearLayout.VERTICAL)
...
//        ZDialog.with(MainActivity_bak.this)
...
//                            return;
//                        }
//                        if (TimetableHelper.saveNote(MainActivity_bak.this, subject, note)) {
//                            dialog.dismiss();
//                            AToast.normal("保存成功！");
...
//                                            try {
//                                                TimetableHelper.writeToJson(MainActivity_bak.this, jsonObject);
//                                            } catch (Exception e) {
//                                                e.printStackTrace();
//                                            }
//                                        }
...
//                                            try {
//                                                TimetableHelper.writeSemesterFile(MainActivity_bak.this, json);
//                                            } catch (Exception e) {
//                                                e.printStackTrace();
//                                            }
//                                        }
...
//                    startActivity(new Intent(MainActivity_bak.this, LoginActivity.class));
//                    finish();
//                    return;
//                }
