...
public class QXDownloadService extends Service implements DownloadMission.MissionListener {

    private static final String TAG = QXDownloadService.class.getSimpleName();
...
//			startForeground(1000, null);
    ...
    public class DMBinder extends Binder {
        ...
        public void onMissionAdded(DownloadMission mission) {
            mission.addListener(QXDownloadService.this);
            mission.setErrCode(-1);
            postUpdateMessage();
        }

        public void onMissionRemoved(DownloadMission mission) {
            mission.removeListener(QXDownloadService.this);
            postUpdateMessage();
        }
